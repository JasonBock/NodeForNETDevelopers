...
var people = require("../Person/Person");

var person = new people.Person.TypeScript.Person(new Date(1970, 1, 1), "Joe Smith");
...
personProxy(personProxyInput, function (error, result) {
